...
function PlayerControls({
    ...
    function whilePlaying() {
        if (progressBar.current.value == NaN)
            return;
    ...
    return ( <
        ...
        <
        div className = { style.currentTime } > { secondsToMinutesAndSeconds(currentTime) } <
        /div> <
        div >
        <
        input type = "range"
        ...
        /> < /
        div > <
        div className = { style.currentTime } > { millisToMinutesAndSeconds(duration) } <
        /div> < /
        div > <
